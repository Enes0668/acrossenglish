...
class _LevelTestPageState extends State<LevelTestPage> {
  ...
  void _loadQuestionsForLevel(String level) {
    setState(() {
      _currentLevel = level;
      _currentBatch = levelTestQuestions[level] ?? [];
          ...
          TextButton(
            onPressed: () async {
               ...
               if (context.mounted) {
                 ...
                 // Navigate to Home or handle as requested
                 Navigator.of(context).pop(); // Go back to previous screen (likely Settings or Register flow)
               }
            },
                ...
                children: question.options.map((option) => Padding(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      padding: const EdgeInsets.all(16),
                      backgroundColor: _selectedOption == option ? Colors.deepPurple.withOpacity(0.1) : null,
                      side: BorderSide(
